...
class local_bankActividades extends external_api
{
    /* 
    ...
    public static function find_get_actividad_parameters() {
     ...
     * return {objet}
     */
    public static function find_get_actividad($obj_perm) {
        global $DB, $USER, $CFG;
     ...
     */
    public static function find_get_actividad_returns() {
