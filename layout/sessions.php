...
switch ($att->pageparams->action) {
    ...
    case mod_attendance_sessions_page_params::ACTION_DELETE_SELECTED:
        ...
        $params = array(
            'action' => $att->pageparams->action, 'sessionsids' => $sessionsids,
...
function  bloquearElementos()
{
    ...
    echo '<style>
        .navbar.navbar-fixed-top.moodle-has-zindex, .fixed-top.navbar.navbar-light, 
        .action-menu.moodle-actionmenu.d-inline , .desktop-first-column.block-region, #page-navbar,
        .navbar, .fixed-top, #page-header, .botones-navegacion-actividades, #recursos-uniminuto-format, .btn-chatbot, .help-button
        {
