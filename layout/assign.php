 ...
 */
class mod_assign_mod_form_uvd extends moodleform_mod_uvd
{
...
echo '<style>
        .navbar.navbar-fixed-top.moodle-has-zindex , .fixed-top.navbar.navbar-light, .action-menu.moodle-actionmenu.d-inline, .desktop-first-column.block-region, 
        #course-header, #id_general, #id_submissionsettings, 
        ...
        #id_activitycompletionheader, #id_submitbutton, #id_cancel, #fitem_id_assignsubmission_file_maxsizebytes, #fitem_fgroup_id_assignsubmission_file_filetypes,
        #fitem_id_cmidnumber, #fitem_id_groupingid, #fitem_id_restrictgroupbutton, #id_feedbacktypes, #fitem_id_groupmode, #page-navbar, #theme_boost-drawers-courseindex, #theme_boost-drawers-blocks,
