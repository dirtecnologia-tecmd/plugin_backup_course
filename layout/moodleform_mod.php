 ...
 */
abstract class moodleform_mod_uvd extends moodleform {
    /** Current data */
    protected $current;
    /**
    ...
    public function __construct($current, $section, $cm, $course) {
        ...
        $this->init_features();
        $url = new moodle_url('/local/backup_course/layout/'.$this->_modname.'.php', array('id_act' => $cm->id, 'return' => 1, 'id_curso'=>$course->id));
