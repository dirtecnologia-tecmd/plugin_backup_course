...
class mod_lti_mod_form extends moodleform_mod_uvd {
...
$url = new moodle_url('/local/backup_course/layout/lti.php');
$url->param('update', $id_actividad);
$PAGE->set_url($url);

// Select the "Edit settings" from navigation.
navigation_node::override_active_url(new moodle_url('/local/backup_course/layout/lti.php', array('id_act' => $id_actividad, 'return' => 1, 'id_curso' => $id_course)));
...
echo '<style>
        ...
        #id_activitycompletionheader, #id_submitbutton, #id_cancel, #nav-drawer, .mt-5.mb-1.activity-navigation, #soporte-bar, #page-navbar,
        ...
        #fitem_id_cmidnumber, #fitem_id_groupingid, #fitem_id_restrictgroupbutton, #id_modstandardratings, #id_privacy, .moreless-actions,
