 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_customcert_mod_form extends moodleform_mod_uvd {
...
$url = new moodle_url('/local/backup_course/layout/customcert.php');
$url->param('update', $id_actividad);
$PAGE->set_url($url);

// Select the "Edit settings" from navigation.
navigation_node::override_active_url(new moodle_url('/local/backup_course/layout/customcert.php', array('id_act' => $id_actividad, 'return' => 1, 'id_curso' => $id_course)));
...
echo '<style>
        ...
        #fitem_id_cmidnumber, #fitem_id_groupingid, #fitem_id_restrictgroupbutton, #id_modstandardratings, #id_privacy, .moreless-actions, #id_options,
