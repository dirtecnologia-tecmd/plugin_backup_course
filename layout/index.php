...
$url = new moodle_url("$CFG->wwwroot/local/backup_course/layout/index.php");
...
$gpr = new grade_plugin_return(array( 'plugin'=>'tree', 'courseid'=>$courseid));
...
echo '<style> #gradetreesubmit, .item .action-icon, .moodle-actionmenu ul, 
              #grade_edit_tree_table .action-menu.moodle-actionmenu.d-inline{
                display: none !important;
              } 
              #grade_edit_tree_table .action-menu-trigger{
                display: none !important;
              }
              #grade_edit_tree_table .menubar.d-flex{
                display: none !important;
              }
     </style>';
