 ...
 */
class mod_quiz_mod_form extends moodleform_mod_uvd
{
    ...
    protected function definition()
    {
        ...
        if (property_exists($quizconfig, 'password_adv') && property_exists($quizconfig, 'password')) {
    ...
    public function add_completion_rules()
    {
        ...
        $group[] = $mform->createElement(
            ...
            'completionpass',
            null,
            get_string('completionpass', 'quiz'),
            array('group' => 'cpass')
        );
