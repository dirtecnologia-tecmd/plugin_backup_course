...
class workshop {
    ...
    public function grading_strategy_instance() {
        ...
        if (is_null($this->strategyinstance)) {
            ...
            $strategylib = $CFG->dirroot . '/mod/workshop/form/' . $this->strategy . '/lib.php';
    ...
    public function editform_url() {
        global $CFG;
        return new moodle_url('/local/backup_course/update/layouts/workshop/editform.php', array('cmid' => $this->cm->id));
    }
