...
$PAGE->set_url('/local/backup_course/update/layouts/edit.php', $pageparams);
...
if ($editform->is_cancelled()) {
    ...
    echo html_writer::script('SLog.confir_nodos_actu('.$course->id.', '.$course->id.', "course", '.$USER->id.',"'.addslashes(json_encode($data)).'", 0, "../../","'.$redirect.'");'     );
