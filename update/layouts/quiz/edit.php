...
list($thispageurl, $contexts, $cmid, $cm, $quiz, $pagevars) =
        question_edit_setup('editq', '/local/backup_course/update/layouts/quiz/edit.php', true);
...
if (($addquestion = optional_param('addquestion', 0, PARAM_INT)) && confirm_sesskey()) {
    ...
    $arr = array('quizid' => $quiz->id, 'questionid' => $addquestion, 'courseid' => $quiz->course);
    echo '<div id="snackbar"></div>';
    echo html_writer::script('SLog.confir_nodos_actu('.$quiz->course.', '.$quiz->course.', "course", '.$USER->id.',"'.addslashes(json_encode($arr)).'", 0, "../../../","'.$afteractionurl.'");'     );
