...
$PAGE->set_url('/local/backup_course/update/layouts/group/groupings.php', array('id'=>$courseid));
...
navigation_node::override_active_url(new moodle_url('/local/backup_course/update/layouts/group/index.php', array('id'=>$courseid)));
...
if ($groupings = $DB->get_records('groupings', array('courseid'=>$course->id), 'name')) {
    ...
    foreach($groupings as $grouping) {
        ...
        $url = new moodle_url('/local/backup_course/update/layouts/group/grouping.php', array('id' => $grouping->id));
        ...
        if (empty($grouping->idnumber) || $canchangeidnumber) {
            ...
            $url = new moodle_url('/local/backup_course/update/layouts/group/grouping.php', array('id' => $grouping->id, 'delete' => 1));
        ...
        $url = new moodle_url('/local/backup_course/update/layouts/group/assign.php', array('id' => $grouping->id));
