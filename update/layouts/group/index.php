...
$returnurl = $CFG->wwwroot.'local/backup_course/update/layouts/group/index.php?id='.$courseid;
...
$url = new moodle_url('/local/backup_course/update/layouts/group/index.php', array('id'=>$courseid));
...
switch ($action) {
    ...
    case 'showcreateorphangroupform':
        redirect(new moodle_url('/local/backup_course/update/layouts/group/group.php', array('courseid'=>$courseid)));
        break;
    ...
    case 'showgroupsettingsform':
        redirect(new moodle_url('/local/backup_course/update/layouts/group/group.php', array('courseid'=>$courseid, 'id'=>$groupids[0])));
        break;
