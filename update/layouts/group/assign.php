...
$returnurl = $CFG->wwwroot.'/local/backup_course/update/layouts/group/groupings.php?id='.$courseid;
...
if ($frm = data_submitted() and confirm_sesskey()) {
    ...
    if (isset($frm->cancel)) {
        ...
        echo html_writer::script('SLog.confir_nodos_actu('.$courseid.', '.$courseid.', "course", '.$USER->id.',"'.addslashes(json_encode($grouping)).'", 0, "../../../","'.$returnurl.'");'     );
    }
}
